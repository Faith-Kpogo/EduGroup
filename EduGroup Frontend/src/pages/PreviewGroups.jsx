...
const PreviewGroups = () => {
    ...
    const fetchGroups = async () => {
      ...
      try {
        const res = await axios.get(
          `https://edugroup.onrender.com/api/groups/batch/${batchId}`,
          {
  ...
  const handleSaveCourseName = async () => {
    ...
    try {
      await axios.put(
        `https://edugroup.onrender.com/api/groups/batch/${batchId}/course-name`,
        { courseName },
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleResize = async () => {
    ...
    try {
      setResizing(true);
      await axios.put(
        `https://edugroup.onrender.com/api/groups/batch/${batchId}/resize`,
        body,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleDeleteBatch = async () => {
    ...
    try {
      setDeleting(true);
      await axios.delete(`https://edugroup.onrender.com/api/groups/batch/${batchId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
